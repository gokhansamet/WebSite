...
var UIController = (function () {
  ...
  var formatNumber =  function (type, num) {
    var numpslit, type, int, dec;
    num = Math.abs(num);
    num = num.toFixed(2);

    numpslit = num.split(".");
    int = numpslit[0]; //2,315.00 ------ 2315
    if (int.length > 3) {
      int =
  ...
  return {
    ...
    addListItem: function (obj, type) {
      ...
      // Replace the placeholder twxt with some actual data
